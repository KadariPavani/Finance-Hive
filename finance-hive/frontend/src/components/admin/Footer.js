...
function Footer() {
  return (
    <footer className="unique-footer">
      <div className="unique-footer-cta">
      ...
      <div className="unique-footer-content">
        <div className="unique-footer-logo">
          <img src={"/Images/FH_logoFinal.png"} alt="Finance Management Logo" className="unique-footer-logo-img" />
        </div>
        ...
        <div className="unique-col">
          <h4>USEFUL LINKS</h4>
          <a href="/about" className="unique-link-item">| About Us</a>
          <a href="/contact" className="unique-link-item">| Contact Us</a>
          <a href="/privacy-policy" className="unique-link-item">| Privacy Policy</a>
        </div>

        <div className="unique-col">
          <h4>Contact Us</h4>
          <p className="unique-email-footer">
