...
const Tracking = () => {
    ...
    return (
        <div className="dashboard-layout">
            <Navigation userDetails={userDetails} onLogout={handleLogout} toggleSidebar={toggleSidebar}
                isSidebarOpen={isSidebarOpen} />
            <Sidebar userDetails={userDetails} onLogout={handleLogout} isSidebarOpen={isSidebarOpen}
